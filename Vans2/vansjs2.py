...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient("suekayam@gmail.com","kampret123")
...
#ki = LineClient()
ki = LineClient("suekrizky@gmail.com","cekang123")
...
#kk = LineClient()
kk = LineClient("ayamsuek@gmail.com","pekok123")
...
#kc = LineClient()
kc = LineClient("suekkambing@gmail.com","kampang123")
...
#js = LineClient()
js = LineClient("suekbuaya@gmail.com","ayam123")
...
poll = LinePoll(cl)
call = cl
creator = ["u1f4c0a015459fc5f31a6fe1885bfbc1f"]
owner = ["u1f4c0a015459fc5f31a6fe1885bfbc1f"]
admin = ["u1f4c0a015459fc5f31a6fe1885bfbc1f","ub48b3be977608c6377720630360e6a97"]
staff = ["u1f4c0a015459fc5f31a6fe1885bfbc1f"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
...
settings = {
    ...
    "userAgent": [
        ...
        "Mozilla/5.0 (Windows NT 5.18; U; rv:5.0) Gecko/20100101 Firefox/5.0",
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"Naah,,ngintip mele..Nyari aim y..😍😍🤗",
    "Respontag":"Vans hadir😎",
    "welcome":"Welcome & semoga betah..Dont forget cek note ya 👍",
    "comment":"Like z gw mah by VanS",
                 ...
                 if wait["Mentionkick"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, "Jangan tag aim....")
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Bot ☣️BLACK-ROSES-TEAM☣️") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#KICKALL
                          ...
                          if msg._from in creator or msg._from in mid or msg._from in admin:
                              idn = cl.getGroup(msg.to)
                              cbr = [contact.mid for contact in idn.invitee]
                              ninja = [contact.mid for contact in idn.members]
                              for x in cbr:
                                  try:
...
#----------------------------------------------------------------------------
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "❧BLACKROSESTEAM Grup Info\n\n❧Nama Group : {}".format(G.name)+ "\n❧ID Group : {}".format(G.id)+ "\n❧Pembuat : {}".format(G.creator.displayName)+ "\n❧Waktu Dibuat : {}".format(str(timeCreated))+ "\n❧Jumlah Member : {}".format(str(len(G.members)))+ "\n❧Jumlah Pending : {}".format(gPending)+ "\n❧Group Qr : {}".format(gQr)+ "\n❧Group Ticket : {}".format(gTicket))
...
#===========BOT UPDATE============#
                        elif cmd == "hai" or text.lower() == "assalamualaikum,halo,pagi,siang,malam,sore,nah":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❧BLACKROSESTEAM  bot\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.cancelGroupInvitation(msg.to, [JSmid])
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "❧B-R-T Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                               ...
                               for target in targets:
                                   if target not in Bots:
                                       try:
                                           ...
                                           Ticket = cl.reissueGroupTicket(msg.to)
                                           js.acceptGroupInvitationByTicket(msg.to,Ticket)
                                           js.kickoutFromGroup(msg.to, [target])
                                           js.leaveGroup(msg.to)
                                           X = cl.getGroup(msg.to)
                                           X.preventedJoinByTicket = True
                                           cl.updateGroup(X)
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"❧B-R-T Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"❧B-R-T Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
