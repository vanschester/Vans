...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='EDwIwJfqNAelIVTgN2c7.TiS76xDGJgn3CGyWnG5QLW.51O5qxX/UiJ/jC5d6preSktOYIT/IFy3PUNEKfoOrGo=')
...
#ki = LineClient()
ki = LineClient(authToken='EDpSw5G8CD6SdXvJl1g3.Sm67GMVSuaRqhOHROKUC8W.ZjTMxINXrZIV2BTDyg7/Cdf+MWXu5eSCf+0AYspxm2U=')
...
#kk = LineClient()
kk = LineClient(authToken='EDtCWdrsMcflKAM9rqr9.Skb0aLsGmsXtrazPDu6Akq.MGQsmf6kJrlulZt9V+g/OJmTPD0xO1KlBCEBBYC4TGY=')
...
#kc = LineClient()
kc = LineClient(authToken='ED07AJEwiUOgDgX8ZCC6.XlKth+V78wKoYISsKB5tLG.TANeHtidoDixtDdIJKhOa3SPhc5YzQg0/3KCwI94K4g=')
...
#js = LineClient()
js = LineClient(authToken='EDJVy9NgYnazsKYeGt3e.0C44mTUXGdUwwXMmTsKXVG.UHdereJO2D4Y3SzKbjZw68SVR/4Kg5fKb6WZuKdM/0w=')
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"Hai,,ngintip mulu..kangen aku PM z ok...😍😍🤗",
    "Respontag":"SEKARANG TAG BESOK JATUH CINTA",
    "welcome":"Selamat datang & semoga betah..Budayakan cek note ya kawan",
    "comment":"Like like & like by VanS",
